...
CLASSPATH=$CLASSPATH:/root/.m2/repository/org/springframework/spring-aop/4.2.4.RELEASE/spring-aop-4.2.4.RELEASE.jar
CLASSPATH=$CLASSPATH:/root/.m2/repository/aopalliance/aopalliance/1.0/aopalliance-1.0.jar
CLASSPATH=$CLASSPATH:/root/.m2/repository/org/springframework/spring-aop/4.2.4.RELEASE/spring-aop-4.2.4.RELEASE.jar
CLASSPATH=$CLASSPATH:/root/.m2/repository/org/springframework/spring-core/4.2.4.RELEASE/spring-core-4.2.4.RELEASE.jar
CLASSPATH=$CLASSPATH:/root/.m2/repository/org/springframework/spring-expression/4.2.4.RELEASE/spring-expression-4.2.4.RELEASE.jar
CLASSPATH=$CLASSPATH:
